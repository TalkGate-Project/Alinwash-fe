  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container-main grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-16">
        ...
        {/* 우측 텍스트 영역 */}
        <div>
          <p className="text-eyebrow font-semibold leading-[28px] text-heading">Why Alinwash?</p>
          <h2 className="mt-2 md:mt-4 text-2xl font-bold md:text-section-title md:leading-[52px] tracking-[-0.04em] text-heading">
            Alinwash만의 차별점
          </h2>
          ...
          <div className="mt-2 md:mt-6">
            ...
            <p className="mt-2 text-body leading-[14px] tracking-[-0.04em] text-muted-alt">
          ...
          <Link
            href="/online_inquiry"
            className="w-[288px] h-[50px] rounded-[50px] flex items-center justify-center mt-4 md:mt-10 bg-primary text-body font-semibold text-white transition-colors hover:bg-primary-hover"
          >
            견적 및 예약상담
          </Link>
        </div>
